    ...
    >
      ...
      {numSelected === 1 ? (
        ...
        <>
          ...
          <Tooltip title="Add Supplier" component={Link} to="add">
...
export default function StickyHeadTable() {
  ...
  const deleteItem = async (id) => {
    setOpen(false);
    await services
      .deleteSuppliers(selected)
      .then((res) => {
        console.log(res);
        if (res === true) {
          console.log("Success to delete supplier data");
          setOpenAlert(true);
          setSeverityAlert("success");
          setDepedency((plus) => plus + 1);
          setMessage("Success to delete supplier data!");
          console.log(res);
        } else {
          setOpenAlert(true);
  ...
  const deleteItems = async () => {
    ...
    for (let item of selected) {
      await services.deleteSuppliers(item).then((res) => {
        if (res === true) {
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{row.nib}</TableCell>
                        <TableCell align="left">{row.siup}</TableCell>
                      </TableRow>
                    );
                  })}
              </TableBody>
